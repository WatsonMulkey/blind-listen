...
const CHECKOUT_LINK_EXTEND = 'https://sandbox-api.polar.sh/v1/checkout-links/polar_cl_qFyDJ8jamaayVV12JufISdEukAbrGva4reK3Y1U2gnk/redirect';   // SANDBOX checkout link for the $5 Session Extension (from Polar dashboard)
const CHECKOUT_LINK_PRO = 'https://sandbox-api.polar.sh/v1/checkout-links/polar_cl_m4fnYgC7yisZSGBcq29jzwqPb6BSZYAvyPywV2VuugB/redirect';      // SANDBOX checkout link for the $19 lifetime Pro
